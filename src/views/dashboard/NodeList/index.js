...
const index = () => {
    ...
    const columnDefs = useMemo(() => [
        ...
        // { headerName: "time", field: "time", flex: 2 },
        {
            headerName: 'Time',
            field: 'time',
            flex: 2,
            valueFormatter: (params) => {
                ...
                const dateStr = value.split(",")[0]; // "6/27/2024"
                const date = dayjs(dateStr, 'M/D/YYYY');
            ...
            filterParams: {
                ...
                comparator: (filterDate, cellValue) => {
                    ...
                    const dateStr = cellValue.split(",")[0];
                    const cellDate = dayjs(dateStr, 'M/D/YYYY').startOf('day');
        ...
        { headerName: "test_result", field: "test_result", flex: 2 },
        // { headerName: "meter_no", field: "meter_no", flex: 2 },
    ], []);
